...
<head>
  ...
  <title>About Cucina Fresca — Authentic Italian Dining in Mysuru</title>
    ...
    <main class="flex-1">
      ...
      <section class="relative bg-[var(--espresso)] text-[var(--cream)] pt-36 pb-20 px-5 lg:px-8 overflow-hidden border-b border-[var(--cream)]/10">
        ...
        <div class="relative mx-auto max-w-4xl text-center">
          ...
          <p class="mt-4 text-base sm:text-lg text-[var(--cream)]/80 leading-relaxed max-w-2xl mx-auto">
            Bringing authentic Italian culinary traditions, handmade pasta, and 72-hour stone-baked pizza to Saraswathipuram, Mysuru.
          </p>

          <!-- Hero Highlights Bar -->
          <div class="mt-10 grid grid-cols-3 gap-4 max-w-2xl mx-auto pt-6 border-t border-[var(--cream)]/15">
            <div class="text-center">
              <p class="font-display text-2xl lg:text-3xl font-bold text-accent">4.8★</p>
              <p class="text-xs text-[var(--cream)]/70 mt-1">1,264 Google Reviews</p>
            </div>
            <div class="text-center">
              <p class="font-display text-2xl lg:text-3xl font-bold text-accent">100%</p>
              <p class="text-xs text-[var(--cream)]/70 mt-1">Scratch Made Daily</p>
            </div>
            <div class="text-center">
              <p class="font-display text-2xl lg:text-3xl font-bold text-accent">450°C</p>
              <p class="text-xs text-[var(--cream)]/70 mt-1">Stone Pizza Oven</p>
            </div>
          </div>
        </div>
      </section>

      <!-- Section 1: Our Story (Side-by-Side Balanced Grid) -->
      <section class="py-20 px-5 lg:px-8">
            ...
            <div class="space-y-6">
              ...
              <div class="pt-4 grid grid-cols-2 gap-4">
                <div class="rounded-xl border border-border bg-card p-4">
                  <p class="font-display text-lg font-bold text-accent">100% Scratch Made</p>
                  <p class="text-xs text-muted-foreground mt-1">No pre-packaged sauces or frozen dough. Everything crafted fresh daily.</p>
                </div>
                <div class="rounded-xl border border-border bg-card p-4">
                  <p class="font-display text-lg font-bold text-accent">DOP Ingredients</p>
                  <p class="text-xs text-muted-foreground mt-1">Imported San Marzano tomatoes, Parmigiano-Reggiano &amp; EVOO.</p>
                </div>
              </div>
            </div>

            <!-- Right Side: Storefront Photo Frame -->
            <div class="flex justify-center">
              <div class="relative w-full max-w-lg rounded-2xl border border-border bg-card overflow-hidden shadow-2xl group">
                <div class="aspect-[4/3] overflow-hidden bg-black/40">
                  <img src="../assets/cucina_storefront.png" alt="Cucina Fresca Storefront in Mysuru" class="size-full object-cover transition-transform duration-700 group-hover:scale-105" style="object-position: center 3%;">
                </div>
                <div class="p-5 flex items-center justify-between text-xs border-t border-border bg-card">
                  <span class="font-semibold text-accent font-display text-sm">Cucina Fresca Storefront</span>
                  <span class="text-muted-foreground">3rd Main, Saraswathipuram, Mysuru</span>
                </div>
              </div>
            </div>
      ...
      <!-- Section 2: Four Pillars (4 Column Card Grid) -->
      <section class="bg-secondary/40 py-20 px-5 lg:px-8 border-y border-border">
        <div class="mx-auto max-w-7xl">
          ...
          <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="rounded-xl border border-border bg-card p-6 shadow-sm transition-transform hover:-translate-y-1">
              <div class="size-11 rounded-lg bg-accent/15 text-accent grid place-items-center text-xl mb-4">🍝</div>
              <h3 class="font-display text-lg font-semibold mb-2">Handmade Pasta</h3>
            ...
            <div class="rounded-xl border border-border bg-card p-6 shadow-sm transition-transform hover:-translate-y-1">
              <div class="size-11 rounded-lg bg-accent/15 text-accent grid place-items-center text-xl mb-4">🍕</div>
              <h3 class="font-display text-lg font-semibold mb-2">72-Hour Dough</h3>
              <p class="text-xs leading-relaxed text-muted-foreground">
            ...
            <div class="rounded-xl border border-border bg-card p-6 shadow-sm transition-transform hover:-translate-y-1">
              <div class="size-11 rounded-lg bg-accent/15 text-accent grid place-items-center text-xl mb-4">🇮🇹</div>
              <h3 class="font-display text-lg font-semibold mb-2">DOP Imports</h3>
              <p class="text-xs leading-relaxed text-muted-foreground">
            ...
            <div class="rounded-xl border border-border bg-card p-6 shadow-sm transition-transform hover:-translate-y-1">
              <div class="size-11 rounded-lg bg-accent/15 text-accent grid place-items-center text-xl mb-4">📱</div>
              <h3 class="font-display text-lg font-semibold mb-2">QR Table Service</h3>
              <p class="text-xs leading-relaxed text-muted-foreground">
      ...
      <!-- Section 3: Executive Chef Spotlight -->
      <section class="py-20 px-5 lg:px-8">
        <div class="mx-auto max-w-7xl">
          <div class="rounded-2xl bg-[var(--espresso)] text-[var(--cream)] overflow-hidden shadow-2xl border border-[var(--cream)]/15">
            <div class="grid lg:grid-cols-12 items-center">
              
              <div class="lg:col-span-5 h-80 lg:h-full overflow-hidden">
                <img src="../assets/chef_d8sa3sgc.jpg" alt="Chef Marco Ferretti" class="size-full object-cover">
              </div>

              <div class="lg:col-span-7 p-8 lg:p-12 space-y-5">
                ...
                <p class="text-sm sm:text-base text-[var(--cream)]/90 leading-relaxed font-display italic">
                ...
                <p class="text-xs sm:text-sm text-[var(--cream)]/70 leading-relaxed">
                ...
                <div class="pt-2">
                  <a href="../menu/" class="inline-flex items-center gap-2 rounded-full bg-accent px-6 py-3 text-xs font-bold text-accent-foreground shadow-lg transition-transform hover:-translate-y-0.5">
                    Explore Menu &rarr;
                  </a>
                </div>
              </div>
      ...
      <section class="py-16 px-5 lg:px-8 text-center bg-card border-t border-border">
        <div class="mx-auto max-w-3xl space-y-4">
          <h2 class="font-display text-3xl sm:text-4xl font-bold text-foreground">Experience Authentic Italian Dining</h2>
          ...
          <div class="pt-4 flex flex-wrap justify-center gap-4">
            <a href="../menu/" class="rounded-full bg-accent px-8 py-3.5 text-sm font-bold text-accent-foreground shadow-lg transition-transform hover:-translate-y-0.5">
              View Menu
            </a>
            <a href="../table/07/" class="rounded-full bg-primary px-8 py-3.5 text-sm font-bold text-primary-foreground shadow-lg transition-transform hover:-translate-y-0.5">
              Scan &amp; Order
            </a>
          </div>
        </div>
...
console.log('Successfully redesigned About page in D:/Cucina Fresca/about/index.html!');
